...
public class OpenPlatformMoveController : MonoBehaviour, IPoResettable, IDragStateHandler
{
    [Header("Trigger")]
    ...
    [Tooltip("열릴 때 이동할 로컬/월드 기준 상대 이동값")]
    [SerializeField] Vector3 openDelta = new Vector3(0f, -4f, 0f);
